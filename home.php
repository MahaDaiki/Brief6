        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                Reference:
                <?php echo $item['reference']; ?><br>
                Barcode:
                <?php echo $item['barcode']; ?><br>
                Purchase Price:
                <?php echo $item['purchase_price']; ?><br>
                Final Price:
                <?php echo $item['final_price']; ?><br>
                Price Offer:
                <?php echo $item['price_offer']; ?><br>
                Description:
                <?php echo $item['descrip']; ?><br>
                Min Quantity:
                <?php echo $item['min_quantity']; ?><br>
                Stock Quantity:
                <?php echo $item['stock_quantity']; ?><br>
                Category:
